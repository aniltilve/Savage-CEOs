...
$collapsible-header-color: $secondary-color !default;
$collapsible-border-color: $secondary-color !default;
...
$navbar-font-size: 1.5rem !default;
...
$sidenav-font-size: 2rem !default;
$sidenav-font-color: $secondary-color !default;
